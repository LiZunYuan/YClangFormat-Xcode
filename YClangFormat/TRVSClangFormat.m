...
//  [formatActiveFileItem setKeyEquivalentModifierMask:NSControlKeyMask]; //created by Kenmu, in order to use shortcut key to access it.
  ...
  [formatSelectedCharacters setKeyEquivalentModifierMask:NSControlKeyMask]; //created by, in order to use shortcut key to access it. Kenmu
...
- (void)addMenuItemsToMenu {
  ...
  NSMenuItem *actionMenuItem =
      [[NSMenuItem alloc] initWithTitle:NSLocalizedString(@"YClang Format", nil)
                                 action:NULL
                          keyEquivalent:@""];
  [[menuItem submenu] addItem:actionMenuItem];

  self.formatMenu =
      [[NSMenu alloc] initWithTitle:NSLocalizedString(@"YClang Format", nil)];
  [self addMenuItemsToFormatMenu];
